...
| [Plugin Export Parse Contract](./plugin-export-parse-contract.md) | Two plugin export flavors (with/without top-level `type`); validity gated by `accounts.accounts` structure only | Active |
